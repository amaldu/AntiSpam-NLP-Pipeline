...
def experiment_status(config: dict):
    """Extract experiment details from the configuration."""
    try:
        ...
        logging.error(f"An error occurred while reading experiment details: {e}")
        raise
